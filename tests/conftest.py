...
# Import src.utils to trigger safe globals registration in src/utils/__init__.py
# This ensures registration happens before any checkpoint loading, including in multiprocessing spawn
from src.utils import register_custom_resolvers, register_torch_safe_globals

# Ensure registration happens in conftest for multiprocessing spawn tests
# Child processes start fresh and need this registration before checkpoint loading
