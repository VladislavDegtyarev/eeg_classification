...
def get_wandb_logger(trainer: Trainer) -> WandbLogger:
    ...
    :return: WandbLogger instance.
    :raises Exception: If fast_dev_run is enabled or WandbLogger not found.
    """
...
class WatchModel(Callback):
    ...
    :param log: What to log (gradients, parameters, etc.).
...
class UploadCodeAsArtifact(Callback):
    ...
    def __init__(self, code_dir: str, use_git: bool = True) -> None:
        ...
        :param code_dir: The code directory.
        :param use_git: If using git, then upload all files that are not ignored by git.
