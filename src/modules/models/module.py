...
def set_parameter_requires_grad(
    ...
    :param freeze_layers: List of layer indices which should bre frozen.
    """
...
def get_module_by_name(
    module: torch.Tensor | torch.nn.Module, access_string: str
) -> Any:
    ...
    :param access_string: Access string.
    :return: Submodule found by access string.
    """
...
def replace_module_by_identity(
    ...
    :param module: Input module.
    :param prev: Submodule which should be replaced.
    :param new: Submodule which should use for replacing.
    :param strategy: Replacing mode. Could be `id` or `repr`. Default to `id`.
    """
...
def get_module_attr_by_name_recursively(
    ...
    :param module: Input module.
    :param index: Submodule index, 0 for the first and -1 for the last.
    :param attr_name: Submodule attribute name.
    """
...
class BaseModule(torch.nn.Module):
    def __init__(
        ...
        **kwargs: Any,
        ...
        :param model_repo: Model repository.
        :param freeze_layers: List of layer indices which should bre frozen.
